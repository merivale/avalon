      ...
      {playerIsEvil
        ? (
          <>
            ...
            <p>
              The loyal servants of Arthur have succeeded three quests. You now
              have an opportunity to assassinate Merlin.
            </p>
            <form
              method="POST"
        ...
        : (
          <>
            <h3 class="font-semibold">Assassinate Merlin</h3>
            <p class="py-2">
              The loyal servants of Arthur have succeeded three quests. Waiting
              for evil players to try and assassinate Merlin...
            </p>
          </>
        )}
    </Card>
